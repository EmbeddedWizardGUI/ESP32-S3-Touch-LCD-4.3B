...
/* The class Views::Text provides a kind of view specialized to print the text. 
   ...
   set.
   The text view can be configured to display a blurred shadow behind the original 
   text. For this purpose the properties @ShadowRadius, @ShadowColor and @ShadowOffset 
   allow the configuration of the shadow. Please note, unlike the original text, 
   the shadow is not clipped at the edges of the text view.
...
EW_DEFINE_METHODS( ViewsText, CoreRectView )
  ...
  EW_METHOD( GetClipping,       XRect )( ViewsText _this )
