...
#ifndef _ApplicationSettingsPage1_H
#define _ApplicationSettingsPage1_H
...
/* Forward declaration of the class Application::SettingsPage1 */
#ifndef _ApplicationSettingsPage1_
  EW_DECLARE_CLASS( ApplicationSettingsPage1 )
#define _ApplicationSettingsPage1_
#endif
...
/* Deklaration of class : 'Application::SettingsPage1' */
EW_DEFINE_FIELDS( ApplicationSettingsPage1, CoreGroup )
  ...
  EW_OBJECT  ( PushButtonB,     WidgetSetPushButton )
  ...
  EW_OBJECT  ( TextF,           ViewsText )
  EW_OBJECT  ( ValueDisplayF,   ApplicationSettingsValueDisplay )
  EW_OBJECT  ( HorizontalSliderF, WidgetSetHorizontalSlider )
  EW_OBJECT  ( TextG,           ViewsText )
  EW_OBJECT  ( ValueDisplayG,   ApplicationSettingsValueDisplay )
  EW_OBJECT  ( HorizontalSliderG, WidgetSetHorizontalSlider )
  EW_OBJECT  ( TextH,           ViewsText )
  EW_OBJECT  ( ValueDisplayH,   ApplicationSettingsValueDisplay )
  EW_OBJECT  ( HorizontalSliderH, WidgetSetHorizontalSlider )
  EW_OBJECT  ( Timer,           CoreTimer )
  EW_OBJECT  ( Time,            CoreTime )
  EW_VARIABLE( TimePickerB,     ApplicationDateTimePicker )
...
EW_END_OF_FIELDS( ApplicationSettingsPage1 )

/* Virtual Method Table (VMT) for the class : 'Application::SettingsPage1' */
EW_DEFINE_METHODS( ApplicationSettingsPage1, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSettingsPage1 )
...
#endif /* _ApplicationSettingsPage1_H */
