...
EW_DEFINE_BITMAP_FONT( EwFont_Roboto_HC36_C16, 28, 8, 0, 16 )
  EW_FONT_GLYPH( 0x0000, 1, -21, 11, 21, 13, 0x00000000 ),
  EW_FONT_GLYPH( 0x0020, 0, 0, 0, 0, 7, 0x00000297 ),                  /* ' ' */
  EW_FONT_GLYPH( 0x0021, 2, -21, 4, 21, 8, 0x00000297 ),               /* '!' */
  EW_FONT_GLYPH( 0x0022, 2, -23, 6, 7, 10, 0x00000340 ),               /* '"' */
  EW_FONT_GLYPH( 0x0023, 1, -21, 18, 21, 18, 0x0000039F ),             /* '#' */
  EW_FONT_GLYPH( 0x0024, 1, -25, 15, 28, 17, 0x00000718 ),             /* '$' */
  EW_FONT_GLYPH( 0x0025, 1, -21, 20, 21, 22, 0x00000B48 ),             /* '%' */
  EW_FONT_GLYPH( 0x0026, 1, -21, 18, 21, 19, 0x00000FCB ),             /* '&' */
  EW_FONT_GLYPH( 0x0027, 1, -23, 3, 7, 5, 0x000013F0 ),                /* ''' */
  EW_FONT_GLYPH( 0x0028, 2, -24, 8, 31, 10, 0x0000141D ),              /* '(' */
  EW_FONT_GLYPH( 0x0029, 0, -24, 9, 31, 10, 0x0000165A ),              /* ')' */
  EW_FONT_GLYPH( 0x002A, 0, -21, 13, 12, 13, 0x000018BC ),             /* '*' */
  EW_FONT_GLYPH( 0x002B, 1, -18, 15, 16, 17, 0x00001A91 ),             /* '+' */
  EW_FONT_GLYPH( 0x002C, 0, -3, 5, 7, 6, 0x00001C16 ),                 /* ',' */
  EW_FONT_GLYPH( 0x002D, 0, -10, 8, 2, 8, 0x00001C7A ),                /* '-' */
  EW_FONT_GLYPH( 0x002E, 2, -3, 4, 3, 8, 0x00001CAC ),                 /* '.' */
  EW_FONT_GLYPH( 0x002F, 0, -21, 12, 23, 12, 0x00001CE9 ),             /* '/' */
  EW_FONT_GLYPH( 0x0030, 1, -21, 15, 21, 17, 0x00001F03 ),             /* '0' */
  EW_FONT_GLYPH( 0x0031, 2, -21, 9, 21, 17, 0x000021DB ),              /* '1' */
  EW_FONT_GLYPH( 0x0032, 1, -21, 15, 21, 17, 0x00002312 ),             /* '2' */
  EW_FONT_GLYPH( 0x0033, 1, -21, 14, 21, 17, 0x00002630 ),             /* '3' */
  EW_FONT_GLYPH( 0x0034, 0, -21, 17, 21, 17, 0x00002989 ),             /* '4' */
  EW_FONT_GLYPH( 0x0035, 2, -21, 14, 21, 17, 0x00002C23 ),             /* '5' */
  EW_FONT_GLYPH( 0x0036, 1, -21, 15, 21, 17, 0x00002F32 ),             /* '6' */
  EW_FONT_GLYPH( 0x0037, 1, -21, 15, 21, 17, 0x000032A2 ),             /* '7' */
  EW_FONT_GLYPH( 0x0038, 1, -21, 15, 21, 17, 0x00003531 ),             /* '8' */
  EW_FONT_GLYPH( 0x0039, 1, -21, 14, 21, 17, 0x000038D9 ),             /* '9' */
  EW_FONT_GLYPH( 0x003A, 2, -16, 4, 16, 7, 0x00003C21 ),               /* ':' */
  EW_FONT_GLYPH( 0x003B, 0, -16, 6, 20, 6, 0x00003CD4 ),               /* ';' */
  EW_FONT_GLYPH( 0x003C, 1, -16, 12, 13, 15, 0x00003DCF ),             /* '<' */
  EW_FONT_GLYPH( 0x003D, 2, -14, 13, 8, 16, 0x00003FC0 ),              /* '=' */
  EW_FONT_GLYPH( 0x003E, 2, -16, 13, 13, 16, 0x000040CA ),             /* '>' */
  EW_FONT_GLYPH( 0x003F, 1, -21, 12, 21, 14, 0x000042E7 ),             /* '?' */
  EW_FONT_GLYPH( 0x0040, 1, -21, 25, 27, 27, 0x0000455C ),             /* '@' */
  EW_FONT_GLYPH( 0x0041, 0, -21, 20, 21, 20, 0x00004CB2 ),             /* 'A' */
  EW_FONT_GLYPH( 0x0042, 2, -21, 15, 21, 19, 0x0000502F ),             /* 'B' */
  EW_FONT_GLYPH( 0x0043, 1, -21, 18, 21, 20, 0x0000531D ),             /* 'C' */
  EW_FONT_GLYPH( 0x0044, 2, -21, 16, 21, 20, 0x000056B1 ),             /* 'D' */
  EW_FONT_GLYPH( 0x0045, 2, -21, 14, 21, 17, 0x0000596B ),             /* 'E' */
  EW_FONT_GLYPH( 0x0046, 2, -21, 14, 21, 17, 0x00005B75 ),             /* 'F' */
  EW_FONT_GLYPH( 0x0047, 1, -21, 18, 21, 20, 0x00005D53 ),             /* 'G' */
  EW_FONT_GLYPH( 0x0048, 2, -21, 17, 21, 21, 0x000060F7 ),             /* 'H' */
  EW_FONT_GLYPH( 0x0049, 2, -21, 4, 21, 8, 0x000062D2 ),               /* 'I' */
  EW_FONT_GLYPH( 0x004A, 0, -21, 15, 21, 17, 0x00006337 ),             /* 'J' */
  EW_FONT_GLYPH( 0x004B, 2, -21, 17, 21, 19, 0x00006546 ),             /* 'K' */
  EW_FONT_GLYPH( 0x004C, 2, -21, 14, 21, 16, 0x00006850 ),             /* 'L' */
  EW_FONT_GLYPH( 0x004D, 2, -21, 22, 21, 26, 0x000069B3 ),             /* 'M' */
  EW_FONT_GLYPH( 0x004E, 2, -21, 17, 21, 21, 0x00006D3B ),             /* 'N' */
  EW_FONT_GLYPH( 0x004F, 1, -21, 18, 21, 21, 0x00006F9E ),             /* 'O' */
  EW_FONT_GLYPH( 0x0050, 2, -21, 16, 21, 19, 0x0000732F ),             /* 'P' */
  EW_FONT_GLYPH( 0x0051, 1, -21, 18, 25, 21, 0x000075B7 ),             /* 'Q' */
  EW_FONT_GLYPH( 0x0052, 2, -21, 16, 21, 18, 0x000079F0 ),             /* 'R' */
  EW_FONT_GLYPH( 0x0053, 1, -21, 16, 21, 18, 0x00007CBC ),             /* 'S' */
  EW_FONT_GLYPH( 0x0054, 0, -21, 18, 21, 18, 0x000080B0 ),             /* 'T' */
  EW_FONT_GLYPH( 0x0055, 1, -21, 17, 21, 19, 0x000082B2 ),             /* 'U' */
  EW_FONT_GLYPH( 0x0056, 0, -21, 19, 21, 19, 0x000084FE ),             /* 'V' */
  EW_FONT_GLYPH( 0x0057, 0, -21, 26, 21, 27, 0x0000884C ),             /* 'W' */
  EW_FONT_GLYPH( 0x0058, 0, -21, 18, 21, 19, 0x00008CF6 ),             /* 'X' */
  EW_FONT_GLYPH( 0x0059, 0, -21, 18, 21, 18, 0x0000908D ),             /* 'Y' */
  EW_FONT_GLYPH( 0x005A, 1, -21, 16, 21, 18, 0x00009343 ),             /* 'Z' */
  EW_FONT_GLYPH( 0x005B, 2, -24, 6, 29, 8, 0x00009632 ),               /* '[' */
  EW_FONT_GLYPH( 0x005C, 0, -21, 13, 23, 12, 0x0000971B ),             /* '\' */
  EW_FONT_GLYPH( 0x005D, 0, -24, 6, 29, 8, 0x00009953 ),               /* ']' */
  EW_FONT_GLYPH( 0x005E, 1, -21, 11, 10, 13, 0x00009A38 ),             /* '^' */
  EW_FONT_GLYPH( 0x005F, 0, 0, 14, 2, 14, 0x00009B6B ),                /* '_' */
  EW_FONT_GLYPH( 0x0060, 0, -22, 7, 4, 9, 0x00009BBF ),                /* '`' */
  EW_FONT_GLYPH( 0x0061, 1, -16, 14, 16, 16, 0x00009C1C ),             /* 'a' */
  EW_FONT_GLYPH( 0x0062, 2, -23, 14, 23, 17, 0x00009EBE ),             /* 'b' */
  EW_FONT_GLYPH( 0x0063, 1, -16, 14, 16, 16, 0x0000A155 ),             /* 'c' */
  EW_FONT_GLYPH( 0x0064, 1, -23, 14, 23, 17, 0x0000A3D9 ),             /* 'd' */
  EW_FONT_GLYPH( 0x0065, 1, -16, 14, 16, 16, 0x0000A67C ),             /* 'e' */
  EW_FONT_GLYPH( 0x0066, 0, -23, 11, 23, 10, 0x0000A933 ),             /* 'f' */
  EW_FONT_GLYPH( 0x0067, 1, -16, 14, 22, 17, 0x0000AAD9 ),             /* 'g' */
  EW_FONT_GLYPH( 0x0068, 2, -23, 13, 23, 17, 0x0000AE2C ),             /* 'h' */
  EW_FONT_GLYPH( 0x0069, 2, -22, 4, 22, 7, 0x0000AFF7 ),               /* 'i' */
  EW_FONT_GLYPH( 0x006A, -1, -22, 6, 28, 7, 0x0000B092 ),              /* 'j' */
  EW_FONT_GLYPH( 0x006B, 2, -23, 14, 23, 15, 0x0000B1AF ),             /* 'k' */
  EW_FONT_GLYPH( 0x006C, 2, -23, 3, 23, 7, 0x0000B427 ),               /* 'l' */
  EW_FONT_GLYPH( 0x006D, 1, -16, 24, 16, 26, 0x0000B47A ),             /* 'm' */
  EW_FONT_GLYPH( 0x006E, 2, -16, 13, 16, 17, 0x0000B72C ),             /* 'n' */
  EW_FONT_GLYPH( 0x006F, 1, -16, 15, 16, 17, 0x0000B8A5 ),             /* 'o' */
  EW_FONT_GLYPH( 0x0070, 2, -16, 14, 22, 17, 0x0000BB46 ),             /* 'p' */
  EW_FONT_GLYPH( 0x0071, 1, -16, 14, 22, 17, 0x0000BDF8 ),             /* 'q' */
  EW_FONT_GLYPH( 0x0072, 2, -16, 8, 16, 10, 0x0000C0A3 ),              /* 'r' */
  EW_FONT_GLYPH( 0x0073, 1, -16, 13, 16, 15, 0x0000C180 ),             /* 's' */
  EW_FONT_GLYPH( 0x0074, 0, -20, 9, 20, 10, 0x0000C44C ),              /* 't' */
  EW_FONT_GLYPH( 0x0075, 2, -16, 13, 16, 17, 0x0000C58E ),             /* 'u' */
  EW_FONT_GLYPH( 0x0076, 0, -16, 15, 16, 15, 0x0000C6F1 ),             /* 'v' */
  EW_FONT_GLYPH( 0x0077, 0, -16, 23, 16, 23, 0x0000C91D ),             /* 'w' */
  EW_FONT_GLYPH( 0x0078, 0, -16, 15, 16, 15, 0x0000CC9F ),             /* 'x' */
  EW_FONT_GLYPH( 0x0079, 0, -16, 14, 22, 14, 0x0000CF00 ),             /* 'y' */
  EW_FONT_GLYPH( 0x007A, 1, -16, 13, 16, 15, 0x0000D1D7 ),             /* 'z' */
  EW_FONT_GLYPH( 0x007B, 0, -23, 10, 28, 10, 0x0000D3E7 ),             /* '{' */
  EW_FONT_GLYPH( 0x007C, 2, -21, 3, 25, 7, 0x0000D629 ),               /* '|' */
  EW_FONT_GLYPH( 0x007D, 0, -23, 10, 28, 10, 0x0000D682 ),             /* '}' */
  EW_FONT_GLYPH( 0x007E, 1, -12, 18, 5, 20, 0x0000D8B7 ),              /* '~' */
  EW_FONT_GLYPH( 0x00A0, 0, 0, 0, 0, 7, 0x0000DA04 ),
  EW_FONT_GLYPH( 0x00A1, 1, -16, 5, 21, 7, 0x0000DA04 ),
  EW_FONT_GLYPH( 0x00A2, 1, -20, 14, 24, 16, 0x0000DABC ),
  EW_FONT_GLYPH( 0x00A3, 1, -21, 16, 21, 17, 0x0000DDD3 ),
  EW_FONT_GLYPH( 0x00A4, 1, -19, 19, 20, 21, 0x0000E0A5 ),
  EW_FONT_GLYPH( 0x00A5, 0, -21, 18, 21, 18, 0x0000E508 ),
  EW_FONT_GLYPH( 0x00A6, 2, -21, 3, 25, 7, 0x0000E850 ),
  EW_FONT_GLYPH( 0x00A7, 1, -21, 16, 28, 18, 0x0000E8CB ),
  EW_FONT_GLYPH( 0x00A8, 1, -22, 10, 3, 13, 0x0000EE33 ),
  EW_FONT_GLYPH( 0x00A9, 1, -21, 22, 21, 24, 0x0000EEA3 ),
  EW_FONT_GLYPH( 0x00AA, 1, -21, 11, 11, 13, 0x0000F48D ),
  EW_FONT_GLYPH( 0x00AB, 1, -14, 12, 12, 14, 0x0000F625 ),
  EW_FONT_GLYPH( 0x00AC, 1, -12, 13, 6, 17, 0x0000F813 ),
  EW_FONT_GLYPH( 0x00AD, 0, -10, 8, 2, 8, 0x0000F8BE ),
  EW_FONT_GLYPH( 0x00AE, 1, -21, 22, 21, 24, 0x0000F8F0 ),
  EW_FONT_GLYPH( 0x00AF, 1, -21, 12, 2, 14, 0x0000FE56 ),
  EW_FONT_GLYPH( 0x00B0, 1, -21, 9, 8, 11, 0x0000FE9E ),
  EW_FONT_GLYPH( 0x00B1, 1, -19, 14, 19, 16, 0x0000FFA3 ),
  EW_FONT_GLYPH( 0x00B2, 1, -21, 9, 12, 11, 0x0001016B ),
  EW_FONT_GLYPH( 0x00B3, 0, -21, 10, 12, 11, 0x000102ED ),
  EW_FONT_GLYPH( 0x00B4, 1, -22, 7, 4, 9, 0x000104A7 ),
  EW_FONT_GLYPH( 0x00B5, 2, -16, 13, 22, 17, 0x00010506 ),
  EW_FONT_GLYPH( 0x00B6, 1, -21, 12, 21, 15, 0x000106CE ),
  EW_FONT_GLYPH( 0x00B7, 2, -12, 4, 3, 8, 0x0001087A ),
  EW_FONT_GLYPH( 0x00B8, 1, 0, 5, 6, 7, 0x000108B7 ),
  EW_FONT_GLYPH( 0x00B9, 1, -21, 7, 12, 11, 0x0001092A ),
  EW_FONT_GLYPH( 0x00BA, 2, -21, 10, 11, 14, 0x000109CF ),
  EW_FONT_GLYPH( 0x00BB, 1, -14, 12, 12, 14, 0x00010B31 ),
  EW_FONT_GLYPH( 0x00BC, 0, -21, 22, 21, 22, 0x00010D19 ),
  EW_FONT_GLYPH( 0x00BD, 0, -21, 22, 21, 23, 0x000110E9 ),
  EW_FONT_GLYPH( 0x00BE, 1, -21, 22, 21, 23, 0x00011521 ),
  EW_FONT_GLYPH( 0x00BF, 0, -16, 13, 22, 14, 0x000119F3 ),
  EW_FONT_GLYPH( 0x00C0, 0, -27, 20, 27, 20, 0x00011C8F ),
  EW_FONT_GLYPH( 0x00C1, 0, -27, 20, 27, 20, 0x000120D3 ),
  EW_FONT_GLYPH( 0x00C2, 0, -27, 20, 27, 20, 0x0001251A ),
  EW_FONT_GLYPH( 0x00C3, 0, -27, 20, 27, 20, 0x0001299A ),
  EW_FONT_GLYPH( 0x00C4, 0, -26, 20, 26, 20, 0x00012E3D ),
  EW_FONT_GLYPH( 0x00C5, 0, -29, 20, 29, 20, 0x0001328D ),
  EW_FONT_GLYPH( 0x00C6, -1, -21, 29, 21, 28, 0x00013740 ),
  EW_FONT_GLYPH( 0x00C7, 1, -21, 18, 27, 20, 0x00013BEB ),
  EW_FONT_GLYPH( 0x00C8, 2, -27, 14, 27, 17, 0x00014050 ),
  EW_FONT_GLYPH( 0x00C9, 2, -27, 14, 27, 17, 0x000142FD ),
  EW_FONT_GLYPH( 0x00CA, 2, -27, 14, 27, 17, 0x000145AD ),
  EW_FONT_GLYPH( 0x00CB, 2, -26, 14, 26, 17, 0x00014896 ),
  EW_FONT_GLYPH( 0x00CC, -1, -27, 7, 27, 8, 0x00014B55 ),
  EW_FONT_GLYPH( 0x00CD, 2, -27, 7, 27, 8, 0x00014C72 ),
  EW_FONT_GLYPH( 0x00CE, -1, -27, 10, 27, 8, 0x00014D92 ),
  EW_FONT_GLYPH( 0x00CF, -1, -26, 10, 26, 8, 0x00014F3C ),
  EW_FONT_GLYPH( 0x00D0, 0, -21, 19, 21, 20, 0x000150C0 ),
  EW_FONT_GLYPH( 0x00D1, 2, -27, 17, 27, 21, 0x000153ED ),
  EW_FONT_GLYPH( 0x00D2, 1, -27, 18, 27, 21, 0x00015764 ),
  EW_FONT_GLYPH( 0x00D3, 1, -27, 18, 27, 21, 0x00015BB0 ),
  EW_FONT_GLYPH( 0x00D4, 1, -27, 18, 27, 21, 0x00015FFF ),
  EW_FONT_GLYPH( 0x00D5, 1, -27, 18, 27, 21, 0x00016487 ),
  EW_FONT_GLYPH( 0x00D6, 1, -26, 18, 26, 21, 0x00016932 ),
  EW_FONT_GLYPH( 0x00D7, 1, -16, 14, 13, 16, 0x00016D8C ),
  EW_FONT_GLYPH( 0x00D8, 1, -22, 19, 24, 21, 0x00016FCE ),
  EW_FONT_GLYPH( 0x00D9, 1, -27, 17, 27, 19, 0x0001749B ),
  EW_FONT_GLYPH( 0x00DA, 1, -27, 17, 27, 19, 0x0001779C ),
  EW_FONT_GLYPH( 0x00DB, 1, -27, 17, 27, 19, 0x00017AA0 ),
  EW_FONT_GLYPH( 0x00DC, 1, -26, 17, 26, 19, 0x00017DDD ),
  EW_FONT_GLYPH( 0x00DD, 0, -27, 18, 27, 18, 0x000180ED ),
  EW_FONT_GLYPH( 0x00DE, 2, -21, 15, 21, 18, 0x00018461 ),
  EW_FONT_GLYPH( 0x00DF, 2, -23, 15, 23, 18, 0x000186C5 ),
  EW_FONT_GLYPH( 0x00E0, 1, -22, 14, 22, 16, 0x000189DC ),
  EW_FONT_GLYPH( 0x00E1, 1, -22, 14, 22, 16, 0x00018D21 ),
  EW_FONT_GLYPH( 0x00E2, 1, -22, 14, 22, 16, 0x00019069 ),
  EW_FONT_GLYPH( 0x00E3, 1, -22, 14, 22, 16, 0x000193EA ),
  EW_FONT_GLYPH( 0x00E4, 1, -21, 14, 21, 16, 0x0001978E ),
  EW_FONT_GLYPH( 0x00E5, 1, -24, 14, 24, 16, 0x00019AE5 ),
  EW_FONT_GLYPH( 0x00E6, 1, -16, 24, 16, 25, 0x00019E8D ),
  EW_FONT_GLYPH( 0x00E7, 1, -16, 14, 22, 16, 0x0001A343 ),
  EW_FONT_GLYPH( 0x00E8, 1, -22, 14, 22, 16, 0x0001A67B ),
  EW_FONT_GLYPH( 0x00E9, 1, -22, 14, 22, 16, 0x0001A9D5 ),
  EW_FONT_GLYPH( 0x00EA, 1, -22, 14, 22, 16, 0x0001AD32 ),
  EW_FONT_GLYPH( 0x00EB, 1, -21, 14, 21, 16, 0x0001B0C8 ),
  EW_FONT_GLYPH( 0x00EC, -2, -22, 7, 22, 7, 0x0001B434 ),
  EW_FONT_GLYPH( 0x00ED, 1, -22, 7, 22, 7, 0x0001B52B ),
  EW_FONT_GLYPH( 0x00EE, -1, -22, 10, 22, 7, 0x0001B625 ),
  EW_FONT_GLYPH( 0x00EF, -1, -21, 10, 21, 7, 0x0001B79A ),
  EW_FONT_GLYPH( 0x00F0, 2, -23, 14, 23, 18, 0x0001B8E9 ),
  EW_FONT_GLYPH( 0x00F1, 2, -22, 13, 22, 17, 0x0001BCB1 ),
  EW_FONT_GLYPH( 0x00F2, 1, -22, 15, 22, 17, 0x0001BF26 ),
  EW_FONT_GLYPH( 0x00F3, 1, -22, 15, 22, 17, 0x0001C270 ),
  EW_FONT_GLYPH( 0x00F4, 1, -22, 15, 22, 17, 0x0001C5BD ),
  EW_FONT_GLYPH( 0x00F5, 1, -22, 15, 22, 17, 0x0001C943 ),
  EW_FONT_GLYPH( 0x00F6, 1, -21, 15, 21, 17, 0x0001CCEC ),
  EW_FONT_GLYPH( 0x00F7, 1, -17, 15, 14, 17, 0x0001D047 ),
  EW_FONT_GLYPH( 0x00F8, 1, -18, 15, 20, 17, 0x0001D1F2 ),
  EW_FONT_GLYPH( 0x00F9, 2, -22, 13, 22, 17, 0x0001D575 ),
  EW_FONT_GLYPH( 0x00FA, 2, -22, 13, 22, 17, 0x0001D775 ),
  EW_FONT_GLYPH( 0x00FB, 2, -22, 13, 22, 17, 0x0001D978 ),
  EW_FONT_GLYPH( 0x00FC, 2, -21, 13, 21, 17, 0x0001DBB4 ),
  EW_FONT_GLYPH( 0x00FD, 0, -22, 14, 28, 14, 0x0001DDC7 ),
  EW_FONT_GLYPH( 0x00FE, 2, -23, 14, 29, 17, 0x0001E144 ),
  EW_FONT_GLYPH( 0x00FF, 0, -21, 14, 27, 14, 0x0001E459 ),

  EW_FONT_PIXEL( EwFont_Roboto_HC36_C16, 0x0001E7E5 )           /* ratio 57.09 % */
  ...
  EW_FONT_KERNING_CODES( EwFont_Roboto_HC36_C16 )
  EW_FONT_KERNING_VALUES( EwFont_Roboto_HC36_C16 )
EW_END_OF_BITMAP_FONT( EwFont_Roboto_HC36_C16 )
