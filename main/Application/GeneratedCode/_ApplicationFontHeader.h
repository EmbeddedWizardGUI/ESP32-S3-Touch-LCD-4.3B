...
#include "_EwFont_Calibri_B_HP36_C16.h"

/* Font resource : 'Application::FontHeader' */
EW_DEFINE_FONT_RES( ApplicationFontHeader )
  EW_FONT_ENTRY( EwFont_Calibri_B_HP36_C16, 36, 36, 1, 0, 1, 16 )

  EW_FONT_RANGES( ApplicationFontHeader )

  EW_FONT_MAPPINGS( ApplicationFontHeader )
    EW_FONT_MAPPING( ApplicationFontHeader, Default, 0 )

  EW_FONTS_TABLE( ApplicationFontHeader )
    EW_FONT( ApplicationFontHeader, Default )
EW_END_OF_FONT_RES( ApplicationFontHeader )
