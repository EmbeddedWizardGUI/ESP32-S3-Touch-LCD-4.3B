...
#include "_EwFont_Arial_B_HC40_C16.h"

/* -----------------------------------------------------------------------------
   Resources
   ----------------------------------------------------------------------------- */
EW_DEFINE_FONT_RES( ApplicationFontTitle )
  EW_FONT_ENTRY( EwFont_Arial_B_HC40_C16, 40, 40, 1, 0, 0, 16 )

  EW_FONT_RANGES( ApplicationFontTitle )

  EW_FONT_MAPPINGS( ApplicationFontTitle )
    EW_FONT_MAPPING( ApplicationFontTitle, Default, 0 )

  EW_FONTS_TABLE( ApplicationFontTitle )
    EW_FONT( ApplicationFontTitle, Default )
EW_END_OF_FONT_RES( ApplicationFontTitle )
