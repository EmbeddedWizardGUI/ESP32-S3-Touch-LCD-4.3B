...
#ifndef _ApplicationBottomNote_H
#define _ApplicationBottomNote_H
...
/* Forward declaration of the class Application::BottomNote */
#ifndef _ApplicationBottomNote_
  EW_DECLARE_CLASS( ApplicationBottomNote )
#define _ApplicationBottomNote_
#endif
...
/* The class 'ListItem' implements a list item to select a certain application of 
   the master demo. */
EW_DEFINE_FIELDS( ApplicationBottomNote, CoreGroup )
  EW_OBJECT  ( BottomNoteShadow, ViewsShadow )
  EW_OBJECT  ( BottomNoteBackground, ViewsRectangle )
  EW_OBJECT  ( BottomNoteLine1, ViewsText )
  EW_OBJECT  ( BottomNoteLine2, ViewsText )
  EW_PROPERTY( FirstLine,       XString )
  EW_PROPERTY( SecondLine,      XString )
  EW_PROPERTY( BackgroundColor, XColor )
  EW_PROPERTY( TextColor,       XColor )
EW_END_OF_FIELDS( ApplicationBottomNote )

/* Virtual Method Table (VMT) for the class : 'Application::BottomNote' */
EW_DEFINE_METHODS( ApplicationBottomNote, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationBottomNote )
...
#endif /* _ApplicationBottomNote_H */
