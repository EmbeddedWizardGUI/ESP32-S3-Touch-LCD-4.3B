...
extern const XFntDataRes EwFont_Calibri_HP28_C16;

/* Font resource : 'Application::FontBodyM' */
EW_DEFINE_FONT_RES( ApplicationFontBodyM )
  EW_FONT_ENTRY( EwFont_Calibri_HP28_C16, 28, 28, 1, 0, 1, 16 )

  EW_FONT_RANGES( ApplicationFontBodyM )

  EW_FONT_MAPPINGS( ApplicationFontBodyM )
    EW_FONT_MAPPING( ApplicationFontBodyM, Default, 0 )

  EW_FONTS_TABLE( ApplicationFontBodyM )
    EW_FONT( ApplicationFontBodyM, Default )
EW_END_OF_FONT_RES( ApplicationFontBodyM )
