...
#include "_EwFont_Calibri_HP32_C16.h"

/* Font resource : 'Application::FontBodyL' */
EW_DEFINE_FONT_RES( ApplicationFontBodyL )
  EW_FONT_ENTRY( EwFont_Calibri_HP32_C16, 32, 32, 1, 0, 1, 16 )

  EW_FONT_RANGES( ApplicationFontBodyL )

  EW_FONT_MAPPINGS( ApplicationFontBodyL )
    EW_FONT_MAPPING( ApplicationFontBodyL, Default, 0 )

  EW_FONTS_TABLE( ApplicationFontBodyL )
    EW_FONT( ApplicationFontBodyL, Default )
EW_END_OF_FONT_RES( ApplicationFontBodyL )
