...
#include "_EwFont_Arial_B_HC26_C16.h"

/* Font resource : 'Application::FontButton' */
EW_DEFINE_FONT_RES( ApplicationFontButton )
  EW_FONT_ENTRY( EwFont_Arial_B_HC26_C16, 26, 26, 1, 0, 0, 16 )

  EW_FONT_RANGES( ApplicationFontButton )

  EW_FONT_MAPPINGS( ApplicationFontButton )
    EW_FONT_MAPPING( ApplicationFontButton, Default, 0 )

  EW_FONTS_TABLE( ApplicationFontButton )
    EW_FONT( ApplicationFontButton, Default )
EW_END_OF_FONT_RES( ApplicationFontButton )
