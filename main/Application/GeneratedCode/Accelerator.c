};

/* Constant values used in this 'C' module only. */
static const XRect _Const0000 = {{ 0, 0 }, { 800, 480 }};
static const XColor _Const0001 = { 0x08, 0x08, 0x20, 0xFF };
static const XRect _Const0002 = {{ 0, 50 }, { 630, 480 }};
static const XRect _Const0003 = {{ 650, 20 }, { 770, 50 }};
static const XStringRes _Const0004 = { _StringsDefault0, 0x0003 };
static const XRect _Const0005 = {{ 640, 50 }, { 790, 100 }};
static const XStringRes _Const0006 = { _StringsDefault0, 0x000E };
static const XRect _Const0007 = {{ 650, 130 }, { 770, 160 }};
static const XStringRes _Const0008 = { _StringsDefault0, 0x0015 };
static const XRect _Const0009 = {{ 640, 160 }, { 790, 210 }};
static const XStringRes _Const000A = { _StringsDefault0, 0x001F };
static const XColor _Const000B = { 0xFF, 0xFF, 0xFF, 0xFF };
static const XRect _Const000C = {{ 650, 360 }, { 770, 390 }};
static const XStringRes _Const000D = { _StringsDefault0, 0x0025 };
static const XRect _Const000E = {{ 650, 230 }, { 770, 280 }};
static const XStringRes _Const000F = { _StringsDefault0, 0x002F };
static const XRect _Const0010 = {{ 10, 0 }, { 520, 46 }};
static const XStringRes _Const0011 = { _StringsDefault0, 0x0045 };
static const XRect _Const0012 = {{ 640, 400 }, { 790, 460 }};
static const XStringRes _Const0013 = { _StringsDefault0, 0x0053 };
static const XRect _Const0014 = {{ 660, 290 }, { 764, 349 }};
static const XStringRes _Const0015 = { _StringsDefault0, 0x0059 };
static const XStringRes _Const0016 = { _StringsDefault0, 0x005F };
static const XStringRes _Const0017 = { _StringsDefault0, 0x0064 };
static const XStringRes _Const0018 = { _StringsDefault0, 0x0067 };
static const XStringRes _Const0019 = { _StringsDefault0, 0x0077 };
static const XStringRes _Const001A = { _StringsDefault0, 0x0088 };
static const XStringRes _Const001B = { _StringsDefault0, 0x0097 };
static const XStringRes _Const001C = { _StringsDefault0, 0x00A6 };
static const XStringRes _Const001D = { _StringsDefault0, 0x00BF };
static const XStringRes _Const001E = { _StringsDefault0, 0x00D8 };
...
void AcceleratorAccelerator__Init( AcceleratorAccelerator _this, XObject aLink, XHandle aArg )
{
  ...
  _this->_.XObject._.GCT = EW_CLASS_GCT( AcceleratorAccelerator );

  /* ... then construct all embedded objects */
  ViewsRectangle__Init( &_this->Rectangle, &_this->_.XObject, 0 );
  AcceleratorGraphicsFactory__Init( &_this->GraphicsFactory, &_this->_.XObject, 0 );
  CoreTimer__Init( &_this->PerformanceTimer, &_this->_.XObject, 0 );
  ViewsText__Init( &_this->FpsDescr, &_this->_.XObject, 0 );
  ViewsText__Init( &_this->FpsText, &_this->_.XObject, 0 );
  ViewsText__Init( &_this->CpuDescr, &_this->_.XObject, 0 );
  ViewsText__Init( &_this->CpuText, &_this->_.XObject, 0 );
  ViewsText__Init( &_this->ScenDescr, &_this->_.XObject, 0 );
  ViewsText__Init( &_this->AccelDescr, &_this->_.XObject, 0 );
  ViewsText__Init( &_this->ScenarioText, &_this->_.XObject, 0 );
  WidgetSetPushButton__Init( &_this->PushButton, &_this->_.XObject, 0 );
  CoreTimer__Init( &_this->AutoDemoTimer, &_this->_.XObject, 0 );
  WidgetSetToggleButton__Init( &_this->ToggleButton, &_this->_.XObject, 0 );

  /* Setup the VMT pointer */
  _this->_.VMT = EW_CLASS( AcceleratorAccelerator );
  ...
  WidgetSetPushButton_OnSetAppearance( &_this->PushButton, EwGetAutoObject( &WidgetSetPushButton_Lime_Large, 
  WidgetSetPushButtonConfig ));
  _this->AutoDemoTimer.OnTrigger = EwNewSlot( _this, AcceleratorAccelerator_NextScene );
  _this->GraphicsSystem = EwGetAutoObject( &AcceleratorDevice, AcceleratorDeviceClass );
  WidgetSetToggleButton_OnSetOutlet( &_this->ToggleButton, EwNewRef( EwGetAutoObject( 
  &AcceleratorDevice, AcceleratorDeviceClass ), AcceleratorDeviceClass_OnGetAcceleratorActive, 
  AcceleratorDeviceClass_OnSetAcceleratorActive ));
...
void AcceleratorAccelerator_Init( AcceleratorAccelerator _this, XHandle aArg )
{
  ...
  ViewsText_OnSetVisible( &_this->CpuDescr, 0 );
  ViewsText_OnSetVisible( &_this->CpuText, 0 );
  ...
  sender )
{
  ...
  cpu = AcceleratorDeviceClass_GetCpuLoad( _this->GraphicsSystem );
...
EW_DEFINE_CLASS( AcceleratorAccelerator, CoreGroup, Rectangle, GraphicsSystem, NoOfRectBlend, 
                 NoOfRectBlend, NoOfRectBlend, NoOfRectBlend, "Accelerator::Accelerator" )
...
void AcceleratorGraphicsFactory__Init( AcceleratorGraphicsFactory _this, XObject aLink, XHandle aArg )
{
  ...
  /* Allow the Immediate Garbage Collection to evalute the members of this class. */
  _this->_.XObject._.GCT = EW_CLASS_GCT( AcceleratorGraphicsFactory );

  /* Setup the VMT pointer */
  _this->_.VMT = EW_CLASS( AcceleratorGraphicsFactory );
...
EW_DEFINE_CLASS( AcceleratorGraphicsFactory, CoreGroup, NativeImages, NativeImages, 
...
/* Initializer for the class 'Accelerator::DeviceClass' */
void AcceleratorDeviceClass__Init( AcceleratorDeviceClass _this, XObject aLink, XHandle aArg )
{
  /* At first initialize the super class ... */
  TemplatesDeviceClass__Init( &_this->_.Super, aLink, aArg );

  /* Allow the Immediate Garbage Collection to evalute the members of this class. */
  _this->_.XObject._.GCT = EW_CLASS_GCT( AcceleratorDeviceClass );

  /* Setup the VMT pointer */
  _this->_.VMT = EW_CLASS( AcceleratorDeviceClass );

  /* ... and initialize objects, variables, properties, etc. */
  _this->AcceleratorActive = 1;

  /* Call the user defined constructor */
  AcceleratorDeviceClass_Init( _this, aArg );
}

/* Re-Initializer for the class 'Accelerator::DeviceClass' */
void AcceleratorDeviceClass__ReInit( AcceleratorDeviceClass _this )
{
  /* At first re-initialize the super class ... */
  TemplatesDeviceClass__ReInit( &_this->_.Super );
}

/* Finalizer method for the class 'Accelerator::DeviceClass' */
void AcceleratorDeviceClass__Done( AcceleratorDeviceClass _this )
{
  /* Call the user defined destructor of the class */
  AcceleratorDeviceClass_Done( _this );
...
/* 'C' function for method : 'Accelerator::DeviceClass.Done()' */
void AcceleratorDeviceClass_Done( AcceleratorDeviceClass _this )
{
  /* Dummy expressions to avoid the 'C' warning 'unused argument'. */
  EW_UNUSED_ARG( _this );
}

/* 'C' function for method : 'Accelerator::DeviceClass.Init()' */
void AcceleratorDeviceClass_Init( AcceleratorDeviceClass _this, XHandle aArg )
{
  /* Dummy expressions to avoid the 'C' warning 'unused argument'. */
  EW_UNUSED_ARG( _this );
  EW_UNUSED_ARG( aArg );
...
/* 'C' function for method : 'Accelerator::DeviceClass.OnSetAcceleratorActive()' */
void AcceleratorDeviceClass_OnSetAcceleratorActive( AcceleratorDeviceClass _this, 
  XBool value )
{
  _this->AcceleratorActive = value;
  EwNotifyRefObservers( EwNewRef( _this, AcceleratorDeviceClass_OnGetAcceleratorActive, 
    AcceleratorDeviceClass_OnSetAcceleratorActive ), 0 );
}

/* The method 'GetCpuLoad' returns the current CPU usage in percent since last call 
   of this method. */
XInt32 AcceleratorDeviceClass_GetCpuLoad( AcceleratorDeviceClass _this )
{
  /* Dummy expressions to avoid the 'C' warning 'unused argument'. */
  EW_UNUSED_ARG( _this );
...
XBool AcceleratorDeviceClass_OnGetAcceleratorActive( AcceleratorDeviceClass _this )
{
  return _this->AcceleratorActive;
}

/* Variants derived from the class : 'Accelerator::DeviceClass' */
EW_DEFINE_CLASS_VARIANTS( AcceleratorDeviceClass )
EW_END_OF_CLASS_VARIANTS( AcceleratorDeviceClass )

/* Virtual Method Table (VMT) for the class : 'Accelerator::DeviceClass' */
EW_DEFINE_CLASS( AcceleratorDeviceClass, TemplatesDeviceClass, _.VMT, _.VMT, _.VMT, 
                 _.VMT, _.VMT, _.VMT, "Accelerator::DeviceClass" )
EW_END_OF_CLASS( AcceleratorDeviceClass )

/* User defined auto object: 'Accelerator::Device' */
EW_DEFINE_AUTOOBJECT( AcceleratorDevice, AcceleratorDeviceClass )

/* Initializer for the auto object 'Accelerator::Device' */
void AcceleratorDevice__Init( AcceleratorDeviceClass _this )
{
  EW_UNUSED_ARG( _this );
}

/* Re-Initializer for the auto object 'Accelerator::Device' */
void AcceleratorDevice__ReInit( AcceleratorDeviceClass _this )
{
  EW_UNUSED_ARG( _this );
}

/* Table with links to derived variants of the auto object : 'Accelerator::Device' */
EW_DEFINE_AUTOOBJECT_VARIANTS( AcceleratorDevice )
EW_END_OF_AUTOOBJECT_VARIANTS( AcceleratorDevice )
