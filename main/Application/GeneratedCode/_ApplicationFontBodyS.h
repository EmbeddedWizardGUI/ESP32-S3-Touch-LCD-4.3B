...
#include "_EwFont_Calibri_HP22_C16.h"

/* Font resource : 'Application::FontBodyS' */
EW_DEFINE_FONT_RES( ApplicationFontBodyS )
  EW_FONT_ENTRY( EwFont_Calibri_HP22_C16, 22, 22, 1, 0, 1, 16 )

  EW_FONT_RANGES( ApplicationFontBodyS )

  EW_FONT_MAPPINGS( ApplicationFontBodyS )
    EW_FONT_MAPPING( ApplicationFontBodyS, Default, 0 )

  EW_FONTS_TABLE( ApplicationFontBodyS )
    EW_FONT( ApplicationFontBodyS, Default )
EW_END_OF_FONT_RES( ApplicationFontBodyS )
