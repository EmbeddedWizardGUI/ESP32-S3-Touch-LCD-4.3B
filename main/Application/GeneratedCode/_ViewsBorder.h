...
#ifndef _ViewsBorder_H
#define _ViewsBorder_H
...
/* The class Views::Border provides a kind of view specialized to draw a rectangular 
   border. The position and the size of the border are determined by the property 
   @Bounds. The border is drawn with the thickness defined in the property @Width. 
   The corners of the displayed border can be rounded. For this purpose the property 
   @Radius can be used. Alternatively, the rounding for the corners can be configured 
   individually by using the properties @RadiusTL, @RadiusTR, @RadiusBR and @RadiusBL.
   The color to draw the border is defined by the property @Color. Alternatively, 
   the border can be drawn with a color gradient specified by the properties @ColorTL, 
...
EW_DEFINE_METHODS( ViewsBorder, CoreRectView )
  EW_METHOD( initLayoutContext, void )( CoreRectView _this, XRect aBounds, CoreOutline 
    aOutline )
  EW_METHOD( GetRoot,           CoreRoot )( CoreView _this )
  EW_METHOD( Draw,              void )( ViewsBorder _this, GraphicsCanvas aCanvas, 
