...
#include "_EwFont_Courier_New_HC22_C16.h"

/* Monospaced font for the result list - lines up the columns nicely. */
EW_DEFINE_FONT_RES( ApplicationFontList )
  EW_FONT_ENTRY( EwFont_Courier_New_HC22_C16, 22, 22, 1, 0, 0, 16 )

  EW_FONT_RANGES( ApplicationFontList )

  EW_FONT_MAPPINGS( ApplicationFontList )
    EW_FONT_MAPPING( ApplicationFontList, Default, 0 )

  EW_FONTS_TABLE( ApplicationFontList )
    EW_FONT( ApplicationFontList, Default )
EW_END_OF_FONT_RES( ApplicationFontList )
