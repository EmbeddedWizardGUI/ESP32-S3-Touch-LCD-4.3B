...
#ifndef _ApplicationEventsDialogue_H
#define _ApplicationEventsDialogue_H
...
/* Forward declaration of the class Application::EventsDialogue */
#ifndef _ApplicationEventsDialogue_
  EW_DECLARE_CLASS( ApplicationEventsDialogue )
#define _ApplicationEventsDialogue_
#endif
...
/* Deklaration of class : 'Application::EventsDialogue' */
EW_DEFINE_FIELDS( ApplicationEventsDialogue, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationEventsDialogue )

/* Virtual Method Table (VMT) for the class : 'Application::EventsDialogue' */
EW_DEFINE_METHODS( ApplicationEventsDialogue, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationEventsDialogue )
...
#endif /* _ApplicationEventsDialogue_H */
