...
typedef XEnum AcceleratorGraphicsType;

#define AcceleratorGraphicsTypeRectFill                     0
#define AcceleratorGraphicsTypeRectBlend                    1
#define AcceleratorGraphicsTypeRGB565Bmp                    2
#define AcceleratorGraphicsTypeRGB565BmpOpacity             3
#define AcceleratorGraphicsTypeNativeBmp                    4
#define AcceleratorGraphicsTypeNativeBmpOpacity             5
#define AcceleratorGraphicsTypeAlpha8Bmp                    6

/* User defined auto object: 'Accelerator::Device' */
EW_DECLARE_AUTOOBJECT( AcceleratorDevice, AcceleratorDeviceClass )
