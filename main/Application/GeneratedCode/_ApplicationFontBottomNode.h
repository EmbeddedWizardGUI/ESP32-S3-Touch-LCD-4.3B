...
#include "_EwFont_Calibri_B_HP24_C16.h"

/* Font resource : 'Application::FontBottomNode' */
EW_DEFINE_FONT_RES( ApplicationFontBottomNode )
  EW_FONT_ENTRY( EwFont_Calibri_B_HP24_C16, 24, 24, 1, 0, 1, 16 )

  EW_FONT_RANGES( ApplicationFontBottomNode )

  EW_FONT_MAPPINGS( ApplicationFontBottomNode )
    EW_FONT_MAPPING( ApplicationFontBottomNode, Default, 0 )

  EW_FONTS_TABLE( ApplicationFontBottomNode )
    EW_FONT( ApplicationFontBottomNode, Default )
EW_END_OF_FONT_RES( ApplicationFontBottomNode )
