...
static const XStringRes _Const0004 = { _StringsDefault0, 0x0044 };
static const XStringRes _Const0005 = { _StringsDefault0, 0x006B };
static const XStringRes _Const0006 = { _StringsDefault0, 0x00A7 };
...
EW_DEFINE_CLASS( EffectsRectEffect, EffectsEffect, Outlet, Outlet, Outlet, Outlet, 
...
EW_DEFINE_CLASS( EffectsColorEffect, EffectsEffect, _.VMT, _.VMT, _.VMT, _.VMT, 
                 _.VMT, _.VMT, "Effects::ColorEffect" )
...
EW_DEFINE_CLASS( EffectsPositionFader, EffectsFader, OpacityEffect, finished, finished, 
                 finished, finished, finished, "Effects::PositionFader" )
...
void EffectsSlideTransition__Init( EffectsSlideTransition _this, XObject aLink, XHandle aArg )
{
  ...
  /* ... and initialize objects, variables, properties, etc. */
  _this->Elasticity = 0.5f;
  _this->OpacityFadeOut = 1;
  _this->OpacityFadeIn = 1;
  _this->Duration = 500;
...
EffectsFader EffectsSlideTransition_CreatePresentFader( EffectsSlideTransition _this )
{
  ...
  EffectsEffect_OnSetCycleDuration((EffectsEffect)&fader->OpacityEffect, ( _this->OpacityFadeIn? 
  _this->Duration : 1 ));
...
EffectsFader EffectsSlideTransition_CreateDismissFader( EffectsSlideTransition _this )
{
  ...
  EffectsEffect_OnSetCycleDuration((EffectsEffect)&fader->OpacityEffect, ( _this->OpacityFadeOut? 
  _this->Duration : 1 ));
  EffectsEffect_OnSetInitialDelay((EffectsEffect)&fader->OpacityEffect, ( _this->OpacityFadeOut? 
  0 : _this->Duration - 1 ));
  EffectsEffect_OnSetCycleDuration((EffectsEffect)&fader->PositionEffect, _this->Duration );
  EffectsEffect_OnSetTiming((EffectsEffect)&fader->PositionEffect, EffectsTimingFastIn_EaseOut );
  EffectsEffect_OnSetTimingCustom1((EffectsEffect)&fader->PositionEffect, 0.0f );
