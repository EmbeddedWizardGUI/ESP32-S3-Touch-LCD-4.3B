...
EW_DEFINE_BITMAP_FONT( EwFont_Roboto_HC24_C16, 19, 5, 0, 16 )
  EW_FONT_GLYPH( 0x0000, 1, -14, 7, 14, 9, 0x00000000 ),
  EW_FONT_GLYPH( 0x0020, 0, 0, 0, 0, 5, 0x00000144 ),                  /* ' ' */
  EW_FONT_GLYPH( 0x0021, 1, -14, 3, 14, 5, 0x00000144 ),               /* '!' */
  EW_FONT_GLYPH( 0x0022, 1, -15, 5, 5, 6, 0x000001A6 ),                /* '"' */
  EW_FONT_GLYPH( 0x0023, 1, -14, 12, 14, 12, 0x000001EC ),             /* '#' */
  EW_FONT_GLYPH( 0x0024, 1, -17, 10, 19, 11, 0x000003ED ),             /* '$' */
  EW_FONT_GLYPH( 0x0025, 1, -14, 13, 14, 15, 0x00000651 ),             /* '%' */
  EW_FONT_GLYPH( 0x0026, 1, -14, 12, 14, 12, 0x000008C9 ),             /* '&' */
  EW_FONT_GLYPH( 0x0027, 1, -15, 2, 5, 3, 0x00000B06 ),                /* ''' */
  EW_FONT_GLYPH( 0x0028, 1, -16, 6, 21, 7, 0x00000B1F ),               /* '(' */
  EW_FONT_GLYPH( 0x0029, 0, -16, 6, 21, 7, 0x00000C77 ),               /* ')' */
  EW_FONT_GLYPH( 0x002A, 0, -14, 9, 9, 9, 0x00000DCF ),                /* '*' */
  EW_FONT_GLYPH( 0x002B, 0, -13, 11, 12, 11, 0x00000ECB ),             /* '+' */
  EW_FONT_GLYPH( 0x002C, 0, -2, 3, 5, 4, 0x00000FB5 ),                 /* ',' */
  EW_FONT_GLYPH( 0x002D, 0, -7, 6, 2, 6, 0x00000FEC ),                 /* '-' */
  EW_FONT_GLYPH( 0x002E, 1, -2, 3, 2, 5, 0x00001010 ),                 /* '.' */
  EW_FONT_GLYPH( 0x002F, 0, -14, 8, 15, 8, 0x00001025 ),               /* '/' */
  EW_FONT_GLYPH( 0x0030, 1, -14, 10, 14, 11, 0x00001140 ),             /* '0' */
  EW_FONT_GLYPH( 0x0031, 1, -14, 7, 14, 11, 0x000012C7 ),              /* '1' */
  EW_FONT_GLYPH( 0x0032, 0, -14, 11, 14, 11, 0x0000137F ),             /* '2' */
  EW_FONT_GLYPH( 0x0033, 0, -14, 10, 14, 11, 0x00001553 ),             /* '3' */
  EW_FONT_GLYPH( 0x0034, 0, -14, 11, 14, 11, 0x00001729 ),             /* '4' */
  EW_FONT_GLYPH( 0x0035, 1, -14, 10, 14, 11, 0x00001880 ),             /* '5' */
  EW_FONT_GLYPH( 0x0036, 1, -14, 10, 14, 11, 0x00001A41 ),             /* '6' */
  EW_FONT_GLYPH( 0x0037, 0, -14, 11, 14, 11, 0x00001C10 ),             /* '7' */
  EW_FONT_GLYPH( 0x0038, 1, -14, 10, 14, 11, 0x00001D8D ),             /* '8' */
  EW_FONT_GLYPH( 0x0039, 1, -14, 9, 14, 11, 0x00001F7B ),              /* '9' */
  EW_FONT_GLYPH( 0x003A, 1, -11, 3, 11, 5, 0x0000214E ),               /* ':' */
  EW_FONT_GLYPH( 0x003B, 0, -11, 4, 14, 4, 0x00002199 ),               /* ';' */
  EW_FONT_GLYPH( 0x003C, 0, -11, 9, 9, 10, 0x00002214 ),               /* '<' */
  EW_FONT_GLYPH( 0x003D, 1, -9, 9, 6, 11, 0x00002339 ),                /* '=' */
  EW_FONT_GLYPH( 0x003E, 1, -11, 9, 9, 10, 0x000023DE ),               /* '>' */
  EW_FONT_GLYPH( 0x003F, 0, -14, 9, 14, 9, 0x00002515 ),               /* '?' */
  EW_FONT_GLYPH( 0x0040, 1, -14, 17, 18, 18, 0x00002675 ),             /* '@' */
  EW_FONT_GLYPH( 0x0041, 0, -14, 13, 14, 13, 0x00002A91 ),             /* 'A' */
  EW_FONT_GLYPH( 0x0042, 1, -14, 11, 14, 12, 0x00002C7D ),             /* 'B' */
  EW_FONT_GLYPH( 0x0043, 1, -14, 12, 14, 13, 0x00002E29 ),             /* 'C' */
  EW_FONT_GLYPH( 0x0044, 1, -14, 11, 14, 13, 0x0000301F ),             /* 'D' */
  EW_FONT_GLYPH( 0x0045, 1, -14, 10, 14, 11, 0x00003198 ),             /* 'E' */
  EW_FONT_GLYPH( 0x0046, 1, -14, 10, 14, 11, 0x000032C9 ),             /* 'F' */
  EW_FONT_GLYPH( 0x0047, 1, -14, 12, 14, 14, 0x000033D3 ),             /* 'G' */
  EW_FONT_GLYPH( 0x0048, 1, -14, 12, 14, 14, 0x000035E3 ),             /* 'H' */
  EW_FONT_GLYPH( 0x0049, 1, -14, 3, 14, 5, 0x000036E6 ),               /* 'I' */
  EW_FONT_GLYPH( 0x004A, 0, -14, 10, 14, 11, 0x0000371D ),             /* 'J' */
  EW_FONT_GLYPH( 0x004B, 1, -14, 12, 14, 13, 0x0000382D ),             /* 'K' */
  EW_FONT_GLYPH( 0x004C, 1, -14, 10, 14, 11, 0x000039D8 ),             /* 'L' */
  EW_FONT_GLYPH( 0x004D, 1, -14, 15, 14, 17, 0x00003A90 ),             /* 'M' */
  EW_FONT_GLYPH( 0x004E, 1, -14, 12, 14, 14, 0x00003C96 ),             /* 'N' */
  EW_FONT_GLYPH( 0x004F, 1, -14, 12, 14, 14, 0x00003DFC ),             /* 'O' */
  EW_FONT_GLYPH( 0x0050, 1, -14, 12, 14, 13, 0x00004004 ),             /* 'P' */
  EW_FONT_GLYPH( 0x0051, 1, -14, 12, 17, 14, 0x00004185 ),             /* 'Q' */
  EW_FONT_GLYPH( 0x0052, 1, -14, 11, 14, 12, 0x000043F0 ),             /* 'R' */
  EW_FONT_GLYPH( 0x0053, 0, -14, 12, 14, 12, 0x00004592 ),             /* 'S' */
  EW_FONT_GLYPH( 0x0054, 0, -14, 12, 14, 12, 0x000047EF ),             /* 'T' */
  EW_FONT_GLYPH( 0x0055, 1, -14, 11, 14, 13, 0x000048F2 ),             /* 'U' */
  EW_FONT_GLYPH( 0x0056, 0, -14, 13, 14, 13, 0x00004A23 ),             /* 'V' */
  EW_FONT_GLYPH( 0x0057, 0, -14, 18, 14, 18, 0x00004BF9 ),             /* 'W' */
  EW_FONT_GLYPH( 0x0058, 0, -14, 12, 14, 13, 0x00004EB7 ),             /* 'X' */
  EW_FONT_GLYPH( 0x0059, 0, -14, 12, 14, 12, 0x000050BD ),             /* 'Y' */
  EW_FONT_GLYPH( 0x005A, 0, -14, 12, 14, 12, 0x00005235 ),             /* 'Z' */
  EW_FONT_GLYPH( 0x005B, 1, -16, 5, 19, 5, 0x000053DD ),               /* '[' */
  EW_FONT_GLYPH( 0x005C, 0, -14, 8, 15, 8, 0x00005466 ),               /* '\' */
  EW_FONT_GLYPH( 0x005D, 0, -16, 4, 19, 5, 0x0000558E ),               /* ']' */
  EW_FONT_GLYPH( 0x005E, 0, -14, 8, 7, 8, 0x00005602 ),                /* '^' */
  EW_FONT_GLYPH( 0x005F, 0, 0, 9, 2, 9, 0x000056BA ),                  /* '_' */
  EW_FONT_GLYPH( 0x0060, 0, -15, 5, 3, 6, 0x000056F0 ),                /* '`' */
  EW_FONT_GLYPH( 0x0061, 1, -11, 9, 11, 11, 0x00005728 ),              /* 'a' */
  EW_FONT_GLYPH( 0x0062, 1, -15, 10, 15, 11, 0x00005895 ),             /* 'b' */
  EW_FONT_GLYPH( 0x0063, 0, -11, 10, 11, 10, 0x00005A17 ),             /* 'c' */
  EW_FONT_GLYPH( 0x0064, 0, -15, 10, 15, 11, 0x00005B90 ),             /* 'd' */
  EW_FONT_GLYPH( 0x0065, 1, -11, 10, 11, 11, 0x00005D1B ),             /* 'e' */
  EW_FONT_GLYPH( 0x0066, 0, -15, 7, 15, 7, 0x00005EAD ),               /* 'f' */
  EW_FONT_GLYPH( 0x0067, 0, -11, 10, 15, 11, 0x00005F82 ),             /* 'g' */
  EW_FONT_GLYPH( 0x0068, 1, -15, 9, 15, 11, 0x0000617B ),              /* 'h' */
  EW_FONT_GLYPH( 0x0069, 1, -15, 3, 15, 5, 0x00006275 ),               /* 'i' */
  EW_FONT_GLYPH( 0x006A, -1, -15, 5, 19, 5, 0x000062CF ),              /* 'j' */
  EW_FONT_GLYPH( 0x006B, 1, -15, 10, 15, 10, 0x0000637E ),             /* 'k' */
  EW_FONT_GLYPH( 0x006C, 1, -15, 3, 15, 5, 0x000064D8 ),               /* 'l' */
  EW_FONT_GLYPH( 0x006D, 1, -11, 16, 11, 18, 0x00006512 ),             /* 'm' */
  EW_FONT_GLYPH( 0x006E, 1, -11, 9, 11, 11, 0x000066A1 ),              /* 'n' */
  EW_FONT_GLYPH( 0x006F, 0, -11, 11, 11, 11, 0x00006773 ),             /* 'o' */
  EW_FONT_GLYPH( 0x0070, 1, -11, 10, 15, 11, 0x0000690E ),             /* 'p' */
  EW_FONT_GLYPH( 0x0071, 0, -11, 10, 15, 11, 0x00006AAB ),             /* 'q' */
  EW_FONT_GLYPH( 0x0072, 1, -11, 6, 11, 7, 0x00006C43 ),               /* 'r' */
  EW_FONT_GLYPH( 0x0073, 0, -11, 10, 11, 10, 0x00006CC4 ),             /* 's' */
  EW_FONT_GLYPH( 0x0074, 0, -14, 7, 14, 7, 0x00006E6E ),               /* 't' */
  EW_FONT_GLYPH( 0x0075, 1, -11, 9, 11, 11, 0x00006F22 ),              /* 'u' */
  EW_FONT_GLYPH( 0x0076, 0, -11, 10, 11, 10, 0x00006FEF ),             /* 'v' */
  EW_FONT_GLYPH( 0x0077, 0, -11, 15, 11, 15, 0x0000713A ),             /* 'w' */
  EW_FONT_GLYPH( 0x0078, 0, -11, 10, 11, 10, 0x00007336 ),             /* 'x' */
  EW_FONT_GLYPH( 0x0079, 0, -11, 9, 15, 9, 0x000074AB ),               /* 'y' */
  EW_FONT_GLYPH( 0x007A, 0, -11, 10, 11, 10, 0x00007643 ),             /* 'z' */
  EW_FONT_GLYPH( 0x007B, 0, -16, 7, 20, 7, 0x00007770 ),               /* '{' */
  EW_FONT_GLYPH( 0x007C, 1, -14, 3, 17, 5, 0x000078BA ),               /* '|' */
  EW_FONT_GLYPH( 0x007D, 0, -16, 7, 20, 7, 0x000078F8 ),               /* '}' */
  EW_FONT_GLYPH( 0x007E, 1, -8, 12, 4, 14, 0x00007A45 ),               /* '~' */
  EW_FONT_GLYPH( 0x00A0, 0, 0, 0, 0, 5, 0x00007B01 ),
  EW_FONT_GLYPH( 0x00A1, 1, -11, 3, 15, 5, 0x00007B01 ),
  EW_FONT_GLYPH( 0x00A2, 1, -14, 9, 17, 11, 0x00007B6B ),
  EW_FONT_GLYPH( 0x00A3, 1, -14, 11, 14, 12, 0x00007D24 ),
  EW_FONT_GLYPH( 0x00A4, 0, -13, 14, 14, 14, 0x00007EB3 ),
  EW_FONT_GLYPH( 0x00A5, 0, -14, 12, 14, 12, 0x0000812A ),
  EW_FONT_GLYPH( 0x00A6, 1, -14, 3, 17, 5, 0x0000831B ),
  EW_FONT_GLYPH( 0x00A7, 0, -14, 11, 19, 12, 0x00008375 ),
  EW_FONT_GLYPH( 0x00A8, 1, -14, 7, 2, 8, 0x0000868F ),
  EW_FONT_GLYPH( 0x00A9, 1, -14, 14, 14, 16, 0x000086B1 ),
  EW_FONT_GLYPH( 0x00AA, 1, -14, 7, 7, 9, 0x000089A7 ),
  EW_FONT_GLYPH( 0x00AB, 1, -9, 8, 8, 9, 0x00008A78 ),
  EW_FONT_GLYPH( 0x00AC, 1, -8, 9, 4, 11, 0x00008B6A ),
  EW_FONT_GLYPH( 0x00AD, 0, -7, 6, 2, 6, 0x00008BD2 ),
  EW_FONT_GLYPH( 0x00AE, 1, -14, 14, 14, 16, 0x00008BF6 ),
  EW_FONT_GLYPH( 0x00AF, 1, -14, 8, 1, 9, 0x00008EA0 ),
  EW_FONT_GLYPH( 0x00B0, 1, -14, 6, 6, 7, 0x00008EC9 ),
  EW_FONT_GLYPH( 0x00B1, 1, -12, 9, 12, 11, 0x00008F53 ),
  EW_FONT_GLYPH( 0x00B2, 0, -14, 7, 8, 7, 0x00009045 ),
  EW_FONT_GLYPH( 0x00B3, 0, -14, 7, 8, 7, 0x0000911B ),
  EW_FONT_GLYPH( 0x00B4, 1, -15, 5, 3, 6, 0x0000920A ),
  EW_FONT_GLYPH( 0x00B5, 1, -11, 9, 15, 11, 0x00009244 ),
  EW_FONT_GLYPH( 0x00B6, 0, -14, 9, 14, 10, 0x0000934F ),
  EW_FONT_GLYPH( 0x00B7, 1, -8, 3, 2, 5, 0x00009441 ),
  EW_FONT_GLYPH( 0x00B8, 1, 0, 4, 4, 5, 0x00009457 ),
  EW_FONT_GLYPH( 0x00B9, 1, -14, 4, 8, 7, 0x000094A4 ),
  EW_FONT_GLYPH( 0x00BA, 1, -14, 7, 7, 9, 0x000094F8 ),
  EW_FONT_GLYPH( 0x00BB, 0, -9, 10, 8, 9, 0x000095C9 ),
  EW_FONT_GLYPH( 0x00BC, 1, -14, 13, 14, 15, 0x000096CF ),
  EW_FONT_GLYPH( 0x00BD, 1, -14, 14, 14, 16, 0x000098D4 ),
  EW_FONT_GLYPH( 0x00BE, 0, -14, 15, 14, 16, 0x00009B0B ),
  EW_FONT_GLYPH( 0x00BF, 0, -11, 9, 15, 9, 0x00009DA9 ),
  EW_FONT_GLYPH( 0x00C0, 0, -18, 13, 18, 13, 0x00009F14 ),
  EW_FONT_GLYPH( 0x00C1, 0, -18, 13, 18, 13, 0x0000A16A ),
  EW_FONT_GLYPH( 0x00C2, 0, -18, 13, 18, 13, 0x0000A3C0 ),
  EW_FONT_GLYPH( 0x00C3, 0, -18, 13, 18, 13, 0x0000A639 ),
  EW_FONT_GLYPH( 0x00C4, 0, -17, 13, 17, 13, 0x0000A8B2 ),
  EW_FONT_GLYPH( 0x00C5, 0, -19, 13, 19, 13, 0x0000AAED ),
  EW_FONT_GLYPH( 0x00C6, -1, -14, 20, 14, 19, 0x0000AD6E ),
  EW_FONT_GLYPH( 0x00C7, 1, -14, 12, 18, 13, 0x0000B005 ),
  EW_FONT_GLYPH( 0x00C8, 1, -18, 10, 18, 11, 0x0000B277 ),
  EW_FONT_GLYPH( 0x00C9, 1, -18, 10, 18, 11, 0x0000B406 ),
  EW_FONT_GLYPH( 0x00CA, 1, -18, 10, 18, 11, 0x0000B595 ),
  EW_FONT_GLYPH( 0x00CB, 1, -17, 10, 17, 11, 0x0000B747 ),
  EW_FONT_GLYPH( 0x00CC, -1, -18, 5, 18, 5, 0x0000B8BE ),
  EW_FONT_GLYPH( 0x00CD, 1, -18, 6, 18, 5, 0x0000B95B ),
  EW_FONT_GLYPH( 0x00CE, -1, -18, 7, 18, 5, 0x0000BA0A ),
  EW_FONT_GLYPH( 0x00CF, 0, -17, 7, 17, 5, 0x0000BAEE ),
  EW_FONT_GLYPH( 0x00D0, 0, -14, 13, 14, 13, 0x0000BB9A ),
  EW_FONT_GLYPH( 0x00D1, 1, -18, 12, 18, 14, 0x0000BD66 ),
  EW_FONT_GLYPH( 0x00D2, 1, -18, 12, 18, 14, 0x0000BF55 ),
  EW_FONT_GLYPH( 0x00D3, 1, -18, 12, 18, 14, 0x0000C1C3 ),
  EW_FONT_GLYPH( 0x00D4, 1, -18, 12, 18, 14, 0x0000C431 ),
  EW_FONT_GLYPH( 0x00D5, 1, -18, 12, 18, 14, 0x0000C6C2 ),
  EW_FONT_GLYPH( 0x00D6, 1, -17, 12, 17, 14, 0x0000C953 ),
  EW_FONT_GLYPH( 0x00D7, 0, -11, 10, 9, 11, 0x0000CBA7 ),
  EW_FONT_GLYPH( 0x00D8, 1, -15, 12, 16, 14, 0x0000CD00 ),
  EW_FONT_GLYPH( 0x00D9, 1, -18, 11, 18, 13, 0x0000CF96 ),
  EW_FONT_GLYPH( 0x00DA, 1, -18, 11, 18, 13, 0x0000D129 ),
  EW_FONT_GLYPH( 0x00DB, 1, -18, 11, 18, 13, 0x0000D2BC ),
  EW_FONT_GLYPH( 0x00DC, 1, -17, 11, 17, 13, 0x0000D472 ),
  EW_FONT_GLYPH( 0x00DD, 0, -18, 12, 18, 12, 0x0000D5EC ),
  EW_FONT_GLYPH( 0x00DE, 1, -14, 10, 14, 12, 0x0000D7CA ),
  EW_FONT_GLYPH( 0x00DF, 1, -15, 11, 15, 12, 0x0000D922 ),
  EW_FONT_GLYPH( 0x00E0, 1, -15, 9, 15, 11, 0x0000DAE5 ),
  EW_FONT_GLYPH( 0x00E1, 1, -15, 9, 15, 11, 0x0000DCAC ),
  EW_FONT_GLYPH( 0x00E2, 1, -16, 9, 16, 11, 0x0000DE73 ),
  EW_FONT_GLYPH( 0x00E3, 1, -16, 9, 16, 11, 0x0000E066 ),
  EW_FONT_GLYPH( 0x00E4, 1, -15, 9, 15, 11, 0x0000E259 ),
  EW_FONT_GLYPH( 0x00E5, 1, -16, 9, 16, 11, 0x0000E412 ),
  EW_FONT_GLYPH( 0x00E6, 0, -11, 17, 11, 17, 0x0000E600 ),
  EW_FONT_GLYPH( 0x00E7, 0, -11, 10, 15, 10, 0x0000E8B4 ),
  EW_FONT_GLYPH( 0x00E8, 1, -15, 10, 15, 11, 0x0000EA9C ),
  EW_FONT_GLYPH( 0x00E9, 1, -15, 10, 15, 11, 0x0000EC8C ),
  EW_FONT_GLYPH( 0x00EA, 1, -16, 10, 16, 11, 0x0000EE7C ),
  EW_FONT_GLYPH( 0x00EB, 1, -15, 10, 15, 11, 0x0000F099 ),
  EW_FONT_GLYPH( 0x00EC, -1, -15, 5, 15, 5, 0x0000F27B ),
  EW_FONT_GLYPH( 0x00ED, 1, -15, 5, 15, 5, 0x0000F309 ),
  EW_FONT_GLYPH( 0x00EE, -1, -16, 7, 16, 5, 0x0000F397 ),
  EW_FONT_GLYPH( 0x00EF, -1, -15, 7, 15, 5, 0x0000F46D ),
  EW_FONT_GLYPH( 0x00F0, 1, -15, 10, 15, 12, 0x0000F50B ),
  EW_FONT_GLYPH( 0x00F1, 1, -16, 9, 16, 11, 0x0000F72B ),
  EW_FONT_GLYPH( 0x00F2, 0, -15, 11, 15, 11, 0x0000F883 ),
  EW_FONT_GLYPH( 0x00F3, 0, -15, 11, 15, 11, 0x0000FA80 ),
  EW_FONT_GLYPH( 0x00F4, 0, -16, 11, 16, 11, 0x0000FC7D ),
  EW_FONT_GLYPH( 0x00F5, 0, -16, 11, 16, 11, 0x0000FEA8 ),
  EW_FONT_GLYPH( 0x00F6, 0, -15, 11, 15, 11, 0x000100D3 ),
  EW_FONT_GLYPH( 0x00F7, 0, -12, 11, 10, 11, 0x000102C2 ),
  EW_FONT_GLYPH( 0x00F8, 0, -12, 11, 14, 11, 0x000103B8 ),
  EW_FONT_GLYPH( 0x00F9, 1, -15, 9, 15, 11, 0x000105D3 ),
  EW_FONT_GLYPH( 0x00FA, 1, -15, 9, 15, 11, 0x000106FA ),
  EW_FONT_GLYPH( 0x00FB, 1, -16, 9, 16, 11, 0x00010821 ),
  EW_FONT_GLYPH( 0x00FC, 1, -15, 9, 15, 11, 0x00010974 ),
  EW_FONT_GLYPH( 0x00FD, 0, -15, 9, 19, 9, 0x00010A8D ),
  EW_FONT_GLYPH( 0x00FE, 1, -15, 10, 19, 12, 0x00010C7F ),
  EW_FONT_GLYPH( 0x00FF, 0, -15, 9, 19, 9, 0x00010E33 ),

  EW_FONT_PIXEL( EwFont_Roboto_HC24_C16, 0x00011017 )           /* ratio 68.52 % */
  ...
  EW_FONT_KERNING_CODES( EwFont_Roboto_HC24_C16 )
  EW_FONT_KERNING_VALUES( EwFont_Roboto_HC24_C16 )
EW_END_OF_BITMAP_FONT( EwFont_Roboto_HC24_C16 )
