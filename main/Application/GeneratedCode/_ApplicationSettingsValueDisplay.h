...
#ifndef _ApplicationSettingsValueDisplay_H
#define _ApplicationSettingsValueDisplay_H
...
/* Forward declaration of the class Application::SettingsValueDisplay */
#ifndef _ApplicationSettingsValueDisplay_
  EW_DECLARE_CLASS( ApplicationSettingsValueDisplay )
#define _ApplicationSettingsValueDisplay_
#endif
...
/* The class 'ListItem' implements a list item to select a certain application of 
   the master demo. */
EW_DEFINE_FIELDS( ApplicationSettingsValueDisplay, CoreGroup )
  EW_OBJECT  ( OutletShadow,    ViewsShadow )
  EW_OBJECT  ( OutletBackground, ViewsRectangle )
  EW_OBJECT  ( ValueText,       ViewsText )
  EW_PROPERTY( Value,           XString )
  EW_PROPERTY( Width,           XInt32 )
EW_END_OF_FIELDS( ApplicationSettingsValueDisplay )

/* Virtual Method Table (VMT) for the class : 'Application::SettingsValueDisplay' */
EW_DEFINE_METHODS( ApplicationSettingsValueDisplay, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSettingsValueDisplay )
...
#endif /* _ApplicationSettingsValueDisplay_H */
