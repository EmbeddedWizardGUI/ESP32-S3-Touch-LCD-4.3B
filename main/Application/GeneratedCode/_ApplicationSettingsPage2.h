...
#ifndef _ApplicationSettingsPage2_H
#define _ApplicationSettingsPage2_H
...
/* Forward declaration of the class Application::SettingsPage2 */
#ifndef _ApplicationSettingsPage2_
  EW_DECLARE_CLASS( ApplicationSettingsPage2 )
#define _ApplicationSettingsPage2_
#endif
...
/* Deklaration of class : 'Application::SettingsPage2' */
EW_DEFINE_FIELDS( ApplicationSettingsPage2, CoreGroup )
  EW_OBJECT  ( TextA,           ViewsText )
  EW_OBJECT  ( ValueDisplayA,   ApplicationSettingsValueDisplay )
  ...
  EW_VARIABLE( TimePickerA,     ApplicationHourMinutePicker )
  EW_VARIABLE( TimePickerB,     ApplicationHourMinutePicker )
...
EW_END_OF_FIELDS( ApplicationSettingsPage2 )

/* Virtual Method Table (VMT) for the class : 'Application::SettingsPage2' */
EW_DEFINE_METHODS( ApplicationSettingsPage2, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSettingsPage2 )
...
#endif /* _ApplicationSettingsPage2_H */
