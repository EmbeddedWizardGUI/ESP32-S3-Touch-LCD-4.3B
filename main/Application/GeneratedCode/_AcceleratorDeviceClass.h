...
#ifndef _AcceleratorDeviceClass_H
#define _AcceleratorDeviceClass_H
...
/* Deklaration of class : 'Accelerator::DeviceClass' */
EW_DEFINE_FIELDS( AcceleratorDeviceClass, TemplatesDeviceClass )
  EW_PROPERTY( AcceleratorActive, XBool )
EW_END_OF_FIELDS( AcceleratorDeviceClass )

/* Virtual Method Table (VMT) for the class : 'Accelerator::DeviceClass' */
EW_DEFINE_METHODS( AcceleratorDeviceClass, TemplatesDeviceClass )
EW_END_OF_METHODS( AcceleratorDeviceClass )
...
#endif /* _AcceleratorDeviceClass_H */
