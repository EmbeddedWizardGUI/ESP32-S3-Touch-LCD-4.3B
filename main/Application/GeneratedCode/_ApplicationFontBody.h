...
#include "_EwFont_Arial_HC22_C16.h"

/* Font resource : 'Application::FontBody' */
EW_DEFINE_FONT_RES( ApplicationFontBody )
  EW_FONT_ENTRY( EwFont_Arial_HC22_C16, 22, 22, 1, 0, 0, 16 )

  EW_FONT_RANGES( ApplicationFontBody )

  EW_FONT_MAPPINGS( ApplicationFontBody )
    EW_FONT_MAPPING( ApplicationFontBody, Default, 0 )

  EW_FONTS_TABLE( ApplicationFontBody )
    EW_FONT( ApplicationFontBody, Default )
EW_END_OF_FONT_RES( ApplicationFontBody )
