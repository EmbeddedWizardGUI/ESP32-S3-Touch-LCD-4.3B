...
#include "_EwFont_Calibri_HP28_C16.h"

/* Font resource : 'Application::FontStatusBar' */
EW_DEFINE_FONT_RES( ApplicationFontStatusBar )
  EW_FONT_ENTRY( EwFont_Calibri_HP28_C16, 28, 28, 1, 0, 1, 16 )

  EW_FONT_RANGES( ApplicationFontStatusBar )

  EW_FONT_MAPPINGS( ApplicationFontStatusBar )
    EW_FONT_MAPPING( ApplicationFontStatusBar, Default, 0 )

  EW_FONTS_TABLE( ApplicationFontStatusBar )
    EW_FONT( ApplicationFontStatusBar, Default )
EW_END_OF_FONT_RES( ApplicationFontStatusBar )
