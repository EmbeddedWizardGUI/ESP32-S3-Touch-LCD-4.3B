...
#include "_EwFont_Roboto_HC30_C16.h"

/* Font resource : 'Templates::DefaultFontPicker' */
EW_DEFINE_FONT_RES( TemplatesDefaultFontPicker )
  EW_FONT_ENTRY( EwFont_Roboto_HC30_C16, 30, 30, 1, 0, 0, 16 )

  EW_FONT_RANGES( TemplatesDefaultFontPicker )

  EW_FONT_MAPPINGS( TemplatesDefaultFontPicker )
    EW_FONT_MAPPING( TemplatesDefaultFontPicker, Default, 0 )

  EW_FONTS_TABLE( TemplatesDefaultFontPicker )
    EW_FONT( TemplatesDefaultFontPicker, Default )
EW_END_OF_FONT_RES( TemplatesDefaultFontPicker )
