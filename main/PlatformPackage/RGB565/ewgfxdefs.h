...
/* If not explicitly specified, assume following default value for the maximum
   number of cached glyphs. The value 0 indicates that the maximum number of
   glyphs will be estimated based on the size of the glyph surface cache. */
#ifndef EW_MAX_NO_OF_GLYPHS
  #define EW_MAX_NO_OF_GLYPHS  0
#endif

/* Validate the maximum surface cache size */
#if (( EW_MAX_NO_OF_GLYPHS < 0     ) ||                                        \
     ( EW_MAX_NO_OF_GLYPHS > 65536 ))
  #error "The maximum number of glyphs out of range."
#endif
