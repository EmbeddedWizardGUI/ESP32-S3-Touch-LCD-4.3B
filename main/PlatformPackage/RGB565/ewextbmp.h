...
#define EW_MAGIC_NO_BITMAP_BLOB      0x626D7044
#define EW_MAGIC_NO_BITMAP_BLOB_R90  0x626D7045
#define EW_MAGIC_NO_BITMAP_BLOB_R180 0x626D7046
#define EW_MAGIC_NO_BITMAP_BLOB_R270 0x626D7047
...
*   as it will be stored in the code memory. The second structure XBlobBmpRes
*   has the same function as XBmpRes with the unique difference to be used in
...
#define EW_INCLUDE_BLOB_BITMAP_RES( aName, aUnitId, aMemberId )                \
